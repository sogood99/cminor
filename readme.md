...
本项目主要使用 C# 语言实现，其开发基于 .NET 6 平台，你可以从[这里](https://dotnet.microsoft.com/download)下载其最新的 SDK（包括编译器、包管理器、项目构建工具等）。

> 对于 Windows 和 macOS 用户而言，下载安装包之后直接运行即可。
...
如果想要更新 API 文档的话，你需要使用 [doxygen](https://www.doxygen.nl/index.html)，在本项目根目录下运行 `doxygen` 即可。
